...
<cfset this.name = "mgLoginExample" />
<cfset this.sessionManagement = true />
<cfset this.sessionTimeout = createTimeSpan(0,0,30,0) />
<!--- The following setting is recommended for applications that use both cflogin and session management --->
<cfset this.loginStorage = "session" />

<cfset this.mappings["/mgLoginExample"] = GetDirectoryFromPath(GetCurrentTemplatePath()) />
